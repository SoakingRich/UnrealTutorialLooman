...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_CoOpGame_OnActorKilled__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnActorKilled, AActor*, VictimActor, AActor*, KilledActor, AActor*, Ununused);\n//DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnActorKilled, AActor*, VictimActor, AActor*, KilledActor)\n" },
		{ "ModuleRelativePath", "Public/SGameMode.h" },
		{ "ToolTip", "DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnActorKilled, AActor*, VictimActor, AActor*, KilledActor, AActor*, Ununused);\nDECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnActorKilled, AActor*, VictimActor, AActor*, KilledActor)" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASGameMode_SpawnNewBot_Statics::Function_MetaDataParams[] = {
		{ "Category", "GameMode" },
		{ "Comment", "//hook for bp to spawn single bot\n" },
		{ "ModuleRelativePath", "Public/SGameMode.h" },
		{ "ToolTip", "hook for bp to spawn single bot" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASGameMode_SpawnNewBot, "SpawnNewBot" }, // 1037743083
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASGameMode, 115748291);
